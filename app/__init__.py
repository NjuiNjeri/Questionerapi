...
from app.api.v1.views.meetviews import v1_mymeetups_blueprint as v1
...
from app.api.v1.views.meetviews import v1_mymeetups_blueprint
...
def  create_app():
    ...
    app.register_blueprint(v1_mymeetups_blueprint)
    return app